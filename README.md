...
Bash
git clone [https://github.com/ahnfsdqi/Travel-Trip-Web.git](https://github.com/ahnfsdqi/Travel-Trip-Web.git)
Buka folder project:
...
* **JavaScript (Vanilla JS):** Digunakan untuk interaktivitas komponen seperti navigasi menu *mobile* dan efek *scroll*.
...
└── assets/
    ...
    └── img/            # Aset gambar, ikon, dan logo destinasi
💻 Cara Menjalankan Project Secara Lokal
Clone repositori ini ke komputer lokal Anda:
